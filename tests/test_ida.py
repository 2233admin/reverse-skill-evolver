...
from reverse_skill.ida import find_latest_ida, format_version, ida_release_version, parse_version
...
def test_plugin_manifest_release_ignores_product_build_components() -> None:
    assert ida_release_version("9.4.260714.951") == "9.4"
